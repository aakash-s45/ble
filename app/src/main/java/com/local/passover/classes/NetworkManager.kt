...
//    private var discoveryListener1: NsdManager.DiscoveryListener? = null
//
//    // Used to avoid resolving the same service or our own
//    private val resolvedServiceNames = mutableSetOf<String>()
//    private val resolvedServices = mutableSetOf<NsdServiceInfo>()
...
//
//    fun findMacServer() {
//        if (discoveryListener1 == null) {
//            discoveryListener1 = object : NsdManager.DiscoveryListener {
